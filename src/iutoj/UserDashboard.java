...
//        ProblemsetTable.getTableHeader().setOpaque(false);
    ...
    private void initComponents() {
        ...
        Problem.setFont(new java.awt.Font("Segoe UI Emoji", 0, 18)); // NOI18N
        Problem.setForeground(new java.awt.Color(0, 181, 204));
        Problem.setText("Problem: ");
        SubmitSolPanel.add(Problem, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 160, 30));
